...
const ORDERS: Order[] = [
  {
    id: "#1024",
    product: "Холодильник Midea",
    brand: "Midea",
    client: "Азамат Бердибеков",
    phone: "+996 700 123 456",
    district: "Ленинский",
    price: "48 500 сом",
    installment: "54 000 сом",
  ...
  },
  {
    ...
    brand: "Samsung",
    client: "Айжан Мамытова",
    phone: "+996 550 234 567",
    district: "Октябрьский",
    price: "72 000 сом",
    installment: "80 000 сом",
    status: "В доставке",
    courier: "Александр",
    date: "15.08.2026",
    model: "UE55AU7100",
  ...
  {
    id: "#1022",
    product: "Стиральная машина LG",
    brand: "LG",
    client: "Бакыт Осмонов",
    phone: "+996 777 345 678",
    district: "Первомайский",
    price: "55 000 сом",
    installment: "62 000 сом",
    status: "Доставлен",
    courier: "Коля",
    date: "15.08.2026",
    model: "F4WV510S0E",
  ...
  {
    id: "#1021",
    product: "Духовой шкаф Bosch",
    brand: "Bosch",
    client: "Гүлзат Токтогулова",
    phone: "+996 502 456 789",
    district: "Свердловский",
    price: "38 000 сом",
    installment: "42 000 сом",
  ...
  {
    id: "#1020",
    product: "Пылесос Xiaomi",
    brand: "Xiaomi",
    client: "Эрлан Джакыпов",
    phone: "+996 700 567 890",
    district: "Ленинский",
    price: "18 500 сом",
    installment: "21 000 сом",
    status: "Доставлен",
    courier: "Николай",
    date: "14.08.2026",
    model: "G10",
  ...
  {
    id: "#1019",
    product: "Микроволновка Haier",
    brand: "Haier",
    client: "Айнур Асанова",
    phone: "+996 555 678 901",
    district: "Октябрьский",
    price: "12 000 сом",
    installment: "14 000 сом",
    status: "Доставлен",
    courier: "Александр",
    date: "14.08.2026",
    model: "HSA-2060",
  },
  {
    ...
    brand: "LG",
    client: "Мирлан Сейтбеков",
    phone: "+996 700 789 012",
    district: "Первомайский",
    price: "65 000 сом",
    installment: "72 000 сом",
    status: "Возврат",
    courier: "Коля",
    date: "13.08.2026",
    model: "GN-H702HMHZ",
  ...
  {
    id: "#1017",
    product: "Кондиционер Samsung",
    brand: "Samsung",
    client: "Зайна Байсалова",
    phone: "+996 550 890 123",
    district: "Свердловский",
    price: "85 000 сом",
    installment: "95 000 сом",
    status: "В обработке",
    courier: "—",
    date: "13.08.2026",
  ...
  {
    id: "#1016",
    product: "Посудомойка Bosch",
    brand: "Bosch",
    client: "Нурбек Токтомаматов",
    phone: "+996 502 901 234",
    district: "Ленинский",
    price: "42 000 сом",
    installment: "48 000 сом",
    status: "Закуплен",
    courier: "—",
    date: "13.08.2026",
    model: "SMS44GW00R",
  ...
  {
    id: "#1015",
    product: "Стиральная Midea",
    brand: "Midea",
    client: "Чолпон Акунова",
    phone: "+996 700 012 345",
    district: "Октябрьский",
    price: "47 000 сом",
    installment: "53 000 сом",
    status: "Новый",
    courier: "—",
    date: "12.08.2026",
    model: "MF100W60",
...
function StatusBadge({ status }: { status: string }) {
  return (
    <span
      className={`inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium whitespace-nowrap ${statusColor(status as OrderStatus)}`}
    >
      {status}
    </span>
  );
...
function Btn({
  ...
  const base =
    "inline-flex items-center justify-center gap-1.5 font-medium rounded-lg cursor-pointer border";
  const sizes = {
...
function Sidebar({
  ...
  // mobileOpen -> render as overlay on small screens
  if (mobileOpen) {
    return (
      <div className="fixed inset-0 z-50 md:hidden flex">
        <div className="absolute inset-0 bg-black/40" onClick={onClose} />
        <aside className="relative w-64 h-full flex flex-col bg-slate-900 text-white">
          {/* Logo */}
  ...
  return (
    <aside className="hidden md:flex w-60 h-full flex-col bg-slate-900 text-white shrink-0">
      {/* Logo */}
      <div className="px-5 pt-6 pb-5 border-b border-slate-800">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-indigo-600 flex items-center justify-center text-white font-bold text-sm shrink-0">
...
const PAGE_TITLES: Record<Page, { title: string; subtitle: string }> = {
  ...
  inventory: {
    title: "Остатки",
    subtitle: "Контроль товаров и складских запасов",
  },
...
function Header({
  ...
  const notifs = [
    ...
    },
    {
      id: 2,
      icon: "🟡",
      text: "Новый заказ ожидает закупки",
      time: "15 мин назад",
    },
    {
      id: 3,
      icon: "🔵",
      text: "Заказ #1023 передан курьеру",
      time: "32 мин назад",
    },
    {
      id: 4,
      icon: "🔴",
      text: "Получен возврат по заказу #1018",
      time: "1 час назад",
    },
    {
      id: 5,
      icon: "✅",
      text: "Заказ #1022 успешно доставлен",
      time: "2 час назад",
    },
  ];
    ...
    <header className="h-16 bg-white border-b border-slate-200 flex items-center px-4 md:px-6 gap-4 shrink-0">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-9 pr-4 py-2 text-sm bg-slate-50 border border-slate-200 rounded-lg w-44 md:w-56 outline-none focus:border-indigo-400 focus:bg-white"
        />
      </div>
      {/* Notifications */}
...
function SalesChart() {
  const [period, setPeriod] = useState<
    "Сегодня" | "7 дней" | "30 дней" | "3 месяца"
  >("30 дней");
          ...
          <thead>
            <tr className="border-b border-slate-100">
              {[
                ...
                <th
                  key={h}
                  className="text-left text-xs text-slate-400 font-medium pb-2.5 pr-4 whitespace-nowrap"
                >
                  {h}
                </th>
              ))}
          ...
          <tbody>
            {recent.map((o) => (
              ...
              >
                ...
                <td className="py-2.5 pr-4 text-slate-700 whitespace-nowrap max-w-32 truncate">
                  {o.product}
                </td>
...
function SalesPage({
  ...
  const filtered = ORDERS.filter((o) => {
    ...
    const matchDistrict =
      districtFilter === "Все районы" || o.district === districtFilter;
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <input
          type="date"
          className="px-3 py-2 text-sm bg-white border border-slate-200 rounded-lg outline-none focus:border-indigo-400 cursor-pointer text-slate-600"
        />
        <div className="ml-auto">
          <Btn onClick={onNewSale}>
            <Icon.plus /> Новая продажа
          </Btn>
        </div>
      </div>
      ...
      <Card className="overflow-hidden">
            ...
            <tbody>
              {filtered.map((o) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-slate-700 whitespace-nowrap max-w-36 truncate">
                    {o.product}
                  </td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1">
                      ...
                      <button className="p-1.5 text-slate-400 hover:text-slate-700 hover:bg-slate-100 rounded cursor-pointer">
                        <Icon.edit />
                      </button>
                      <button className="p-1.5 text-slate-400 hover:text-slate-700 hover:bg-slate-100 rounded cursor-pointer">
                        <Icon.dots />
        ...
        <div className="px-4 py-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
          ...
          <div className="flex items-center gap-1">
            <button className="px-2.5 py-1 rounded border border-slate-200 hover:bg-slate-50 cursor-pointer">
              ←
            </button>
            <button className="px-2.5 py-1 rounded bg-indigo-600 text-white">
              1
            </button>
            <button className="px-2.5 py-1 rounded border border-slate-200 hover:bg-slate-50 cursor-pointer">
              2
...
function NewSaleModal({
  ...
  const total = price
    ? `${parseInt(price.replace(/\D/g, "") || "0") * parseInt(qty || "1")} сом`
    : "—";
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl flex overflow-hidden">
        ...
        <div className="flex-1 p-6 overflow-y-auto max-h-[80vh]">
          ...
          <div className="flex items-center justify-end gap-3 mt-6 pt-5 border-t border-slate-100">
            ...
            <Btn onClick={onSave}>
              <Icon.check /> Создать продажу
            </Btn>
          </div>
        </div>

        {/* Summary */}
        <div className="hidden md:flex md:w-56 bg-slate-50 border-l border-slate-200 p-5 flex-col">
          <h3 className="text-sm font-semibold text-slate-900 mb-4">
            Итог заказа
          </h3>
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              ...
              <span className="text-slate-900 text-right max-w-24 text-xs">
                {productName || "—"}
              </span>
            </div>
            <div className="flex justify-between">
...
function OrderDetails({
  ...
  const timelineSteps = [
    ...
    { label: "Проверка остатков", done: true },
    {
      ...
      done: order.status !== "Новый" && order.status !== "В обработке",
      active: order.status === "Ожидает закупки",
    },
    {
      label: "Закуплен",
      done: ["Закуплен", "Передан курьеру", "В доставке", "Доставлен"].includes(
        order.status,
      ),
      active: order.status === "Закуплен",
    },
    {
      label: "Передан курьеру",
      done: ["Передан курьеру", "В доставке", "Доставлен"].includes(
        order.status,
      ),
      active: order.status === "Передан курьеру",
    },
    {
      label: "В доставке",
      done: ["В доставке", "Доставлен"].includes(order.status),
      active: order.status === "В доставке",
    },
    {
      label: "Доставлен",
      done: order.status === "Доставлен",
      active: order.status === "Доставлен",
    },
  ];
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Btn variant="danger" size="sm" onClick={onReturn}>
              <Icon.undo /> Возврат
            </Btn>
            <button
              onClick={onClose}
          ...
          <div className="md:col-span-3 space-y-5">
            ...
            <div className="bg-slate-50 rounded-xl p-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div>
                  <p className="text-slate-500 text-xs">Наименование</p>
                ...
                <div>
                  <p className="text-slate-500 text-xs">Количество</p>
                  <p className="font-medium text-slate-900 mt-0.5">1 шт.</p>
                </div>
                <div>
                  <p className="text-slate-500 text-xs">Бренд</p>
                  <p className="font-medium text-slate-900 mt-0.5">
                    {order.brand}
                  </p>
                </div>
                ...
                <div>
                  <p className="text-slate-500 text-xs">Рассрочка</p>
                  <p className="font-semibold text-slate-900 mt-0.5">
                    {order.installment}
                  </p>
                </div>
            ...
            <div className="bg-slate-50 rounded-xl p-4">
              ...
              <div className="text-sm space-y-1">
                <p className="text-slate-900 font-medium">
                  {order.district} район
                </p>
                <p className="text-slate-600">ул. Киевская, 120</p>
                <p className="text-slate-400 text-xs mt-2">
                  Ориентир: рядом с аптекой «Медикус»
                </p>
              </div>
              {/* Fake map preview */}
                ...
                <div key={i} className="flex gap-3 pb-4 last:pb-0">
                  <div className="flex flex-col items-center">
                    ...
                    {i < timelineSteps.length - 1 && (
                      <div
                        className={`w-0.5 flex-1 mt-1 ${step.done ? "bg-indigo-300" : "bg-slate-200"}`}
                        style={{ minHeight: 20 }}
                      />
                    )}
                  </div>
                  <div className="pt-0.5 pb-4">
                    <p
                      className={`text-sm font-medium ${step.active ? "text-indigo-600" : step.done ? "text-slate-900" : "text-slate-400"}`}
                    >
                      {step.label}
                    </p>
                    {step.active && (
        ...
        <div className="bg-red-50 border border-red-100 rounded-xl p-4 mb-5 text-sm space-y-1">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-slate-900">
              {order.client.split(" ")[0]}
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-slate-500">Курьер</span>
            <span className="font-medium text-slate-900">
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
        ...
        <div className="flex gap-3">
          ...
          <Btn className="flex-1" onClick={onConfirm} disabled={!reason}>
            Подтвердить
          </Btn>
        </div>
      </div>
          ...
          <tbody>
            {filtered.map((p) => (
              <tr
                ...
                className="border-b border-slate-50 hover:bg-slate-50/50 last:border-0 cursor-pointer"
              >
                ...
                <td className="px-4 py-3">
                  <span
                    className={`font-semibold ${p.qty === 0 ? "text-red-600" : p.qty <= p.minQty ? "text-yellow-600" : "text-slate-900"}`}
                  >
                    {p.qty} шт.
                  </span>
                </td>
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-4 space-y-2 text-sm">
              ...
              <div className="border-t border-slate-100 pt-2 flex justify-between">
                ...
                <span
                  className={`font-semibold ${product.qty === 0 ? "text-red-600" : product.qty <= product.minQty ? "text-yellow-600" : "text-green-600"}`}
                >
                  {product.qty} шт.
                </span>
              </div>
              <div className="flex justify-between">
                ...
                <span className="font-medium">{product.minQty} шт.</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="md:col-span-3">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-100">
                  {["Дата", "Операция", "Кол-во", "Сотрудник", "Остаток"].map(
                    (h) => (
                      <th
                        key={h}
                        className="text-left text-xs text-slate-400 font-medium pb-2 pr-3"
                      >
                        {h}
                      </th>
                    ),
              ...
              <tbody>
                {history.map((h, i) => (
                  ...
                  >
                    ...
                    <td
                      className={`py-2.5 pr-3 font-medium ${h.qty > 0 ? "text-green-600" : "text-red-600"}`}
                    >
                      {h.qty > 0 ? `+${h.qty}` : h.qty}
                    </td>
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {requests.length === 0 ? (
            <Card className="md:col-span-2 py-16 text-center">
              <div className="text-4xl mb-3">📋</div>
              ...
              <Card key={o.id} className="p-4">
                ...
                <div className="space-y-1.5 text-sm mb-4">
                  <div className="flex gap-2">
                    <span className="text-slate-400 w-20">Товар</span>
                    <span className="text-slate-900 font-medium">
                      {o.product}
                    </span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-slate-400 w-20">Количество</span>
                    <span className="text-slate-700">2 шт.</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-slate-400 w-20">Клиент</span>
                    <span className="text-slate-700">
                      {o.client.split(" ")[0]}
                    </span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-slate-400 w-20">Район</span>
                    <span className="text-slate-700">{o.district}</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-slate-400 w-20">Стоимость</span>
            ...
            <div className="grid grid-cols-4 gap-3 bg-slate-50 rounded-xl p-3">
              {[
                ...
                },
                {
                  label: "Возвраты",
                  value: c.returns,
                  color: c.returns > 0 ? "text-red-600" : "text-slate-900",
                },
              ].map((s) => (
                <div key={s.label} className="text-center">
                  <p
                    className={`text-xl font-bold ${s.color || "text-slate-900"}`}
                  >
                    {s.value}
                  </p>
        ...
        <div className="p-6">
          <div className="grid grid-cols-4 gap-3 mb-6">
            {[
              ...
              {
                label: "Доставлено",
                value: courier.delivered,
                color: "text-green-600",
              },
              {
                label: "В доставке",
                value: courier.inDelivery,
                color: "text-blue-600",
              },
              {
                label: "Возвраты",
                value: courier.returns,
                color: courier.returns > 0 ? "text-red-600" : "text-slate-900",
              },
            ].map((s) => (
    ...
    <div className="p-6 flex flex-col gap-4 h-full">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-3 py-2 text-sm bg-white border border-slate-200 rounded-lg outline-none focus:border-indigo-400 w-48"
          />
        </div>
        {filters.map((f) => (
          <button
      ...
      <Card className="flex-1 overflow-hidden relative min-h-96">
        ...
        >
          ...
          {/* District fills */}
          <polygon
            points="0,0 280,0 280,250 0,250"
            fill="#EEF2FF"
            opacity="0.7"
          />
          <polygon
            points="280,0 560,0 560,250 280,250"
            fill="#F0FDF4"
            opacity="0.7"
          />
          <polygon
            points="0,250 280,250 280,500 0,500"
            fill="#FFF7ED"
            opacity="0.7"
          />
          <polygon
            points="280,250 560,250 560,500 280,500"
            fill="#FFF1F2"
            opacity="0.7"
          />
          {/* District borders */}
          ...
          {markers.map((m) => (
            <g
              key={m.id}
              onClick={() =>
                setSelectedOrder(selectedOrder === m.id ? null : m.id)
              }
        ...
        {sel && (
          <div className="absolute top-4 right-4 bg-white rounded-xl border border-slate-200 shadow-xl w-64 p-4 z-10">
            ...
            <div className="space-y-1.5 text-sm mb-3">
              <div className="flex gap-2">
                <span className="text-slate-400 w-16">Клиент</span>
                <span className="text-slate-900 font-medium">{sel.client}</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-16">Телефон</span>
                <span className="text-slate-700">{sel.phone}</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-16">Товар</span>
                <span className="text-slate-700">{sel.product}</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-16">Район</span>
                <span className="text-slate-700">{sel.district}</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-16">Адрес</span>
                <span className="text-slate-700">{sel.address}</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-16">Курьер</span>
                <span className="text-slate-700">{sel.courier}</span>
              </div>
              <div className="flex gap-2 items-center">
                <span className="text-slate-400 w-16">Статус</span>
        ...
        <div className="absolute bottom-4 left-4 bg-white rounded-xl border border-slate-200 shadow p-3 flex gap-3 text-xs">
          {[
            { color: "#2563EB", label: "В доставке" },
            { color: "#16A34A", label: "Доставлен" },
            { color: "#D97706", label: "Ожидает" },
            { color: "#4338CA", label: "Назначен" },
          ].map((l) => (
            ...
            <Card className="p-6">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <button className="text-xs text-indigo-600 mt-1 hover:underline cursor-pointer">
                    Изменить фото
                  </button>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                ...
                <Select
                  label="Роль"
                  options={["Администратор", "Менеджер", "Кассир"]}
                  value="Администратор"
                />
              </div>
        ...
        {activeTab === "Районы" && (
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Btn size="sm">
                <Icon.plus /> Добавить район
              </Btn>
            </div>
            <div className="space-y-2">
              {["Ленинский", "Октябрьский", "Первомайский", "Свердловский"].map(
                (d) => (
                  <div
                    key={d}
                    className="flex items-center justify-between p-3 bg-slate-50 rounded-xl"
        ...
        {activeTab === "Склады" && (
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Btn size="sm">
                <Icon.plus /> Добавить склад
              </Btn>
            </div>
            <div className="space-y-2">
              {["Midea", "Samsung", "LG", "Bosch", "Haier", "Общий"].map(
                (w) => (
                  <div
                    key={w}
                    className="flex items-center justify-between p-3 bg-slate-50 rounded-xl"
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              {[
                {
                  label: "Новый заказ",
                  desc: "Уведомлять при создании нового заказа",
                },
                {
                  label: "Товар заканчивается",
                  desc: "Когда остаток ниже минимального",
                },
                {
                  label: "Заказ доставлен",
                  desc: "При успешной доставке заказа",
                },
                { label: "Возврат", desc: "При оформлении возврата" },
                {
                  label: "Заявка на закуп",
                  desc: "При поступлении новой заявки",
                },
              ].map((n) => (
                <div
                  key={n.label}
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <Header page={page} onOpenSidebar={() => setMobileOpen(true)} />
      ...
      {orderDetailId && (
        <OrderDetails
          ...
          onReturn={() => {
            setReturnOrderId(orderDetailId);
          }}
        />
      )}
      {returnOrderId && (
